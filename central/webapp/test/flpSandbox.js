		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Home central app",
									"targetURL": "#comcollakhomecentralcentral-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcollakhomecentralcentral-display": {
								"semanticObject": "comcollakhomecentralcentral",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.collak.home.central.central",
									"url": sap.ui.require.toUrl("com/collak/home/central/central")
								}
							}
						}
					}
